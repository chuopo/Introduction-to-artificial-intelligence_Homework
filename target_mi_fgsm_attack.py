...
# 声明一些攻击参数
CHECKPOINTS_DIR = '/Users/yuqiang/Undergraduate/2019/AI/data/checkpoints/'
...
def load_images_with_target_label(input_dir):
    ...
    for filename in filename2label.keys():
        image = imageio.imread(os.path.join(input_dir, filename), pilmode='RGB')
        images.append(image)
...
if __name__ == '__main__':
     input_dir = '/Users/yuqiang/Undergraduate/2019/AI/dev_data'
     output_dir = '/Users/yuqiang/Undergraduate/2019/AI/output'
